                                ...
                                <form action="">
                                    <div class="select-option">
                                        <select name="sort_by" class="sorting" onchange="this.form.submit();">
                                            ...
                                            <option  {{ request('sort_by') == 'name-asecending' ? 'selected' : '' }} value="name-ascending">Sorting: Name A-Z</option>
                                            ...
                                            <option  {{ request('sort_by') == 'price-descending' ? 'selected' : '' }} value="price-ascending">Sorting: Price Descending</option>
                                        </select>
                        ...
                        <div class="row">
                            @foreach ($products as $product)
                                <div class="col-lg-4 col-sm-6">
                                    @include('fontend.components.product-item')
                                </div>
                            @endforeach
