                        ...
                        <form method="post" action="{{ route('slider.update',$slider->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <img style="height: 200px; cursor: pointer;"
                                         ...
                                         src="{{URL::to('public/fontend/img/slider/' . $slider->image)}}" alt="Avatar">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="tag" id="tag"
                                           placeholder="Tag" type="text" class="form-control" value="{{ $slider->tag }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="sale" id="sale"
                                           placeholder="Sale percent" type="text" class="form-control" value="{{ $slider->sale }}">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group mb-1">
                                <div class="col-md-9 col-xl-8 offset-md-2">
                                    <a href="{{ URL::to('admin/slider') }}" class="border-0 btn btn-outline-danger mr-1">
