                                ...
                                <ul class="text-nowrap" id="images">
                                    ...
                                    @foreach($productImages as $productImage)
                                        <li class="float-left d-inline-block mr-2 mb-2" style="position: relative; width: 32%;">
                                            <form action="{{ URL::to('admin/product/' . $product->id . '/image/' . $productImage->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                            ...
                                            <div style="width: 100%; height: 220px; overflow: hidden;">
                                                <img  src="{{URL::to('public/fontend/img/products/' . $productImage->path)}}"
                                                      alt="Image">
                                            </div>
                                        </li>
                                    @endforeach
                                        ...
                                        <form method="post" action="{{ route('image.store',$product->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div style="width: 100%; max-height: 220px; overflow: hidden;">
                                                <img style="width: 100%; cursor: pointer;"
                                                     ...
                                                     src="{{asset('public/backend/assets/images/add-image-icon.jpg')}}" alt="Add Image">
