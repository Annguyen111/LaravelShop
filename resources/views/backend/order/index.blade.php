                        ...
                        <div class="btn-actions-pane-right">
                            <div role="group" class="btn-group-sm btn-group">
                                <form>
                                    ...
                                    <button type="submit" class="btn btn-focus">Finished</button>
                                </form>
                                <form>
                                    <input type="hidden" name="filter" value="unfinished">
                                    <button type="submit" class="active btn btn-focus">Unfinished</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="widget-content-left mr-3">
                                                    <div class="widget-content-left">
                                                        <img style="height: 60px;"
                                                             ...
                                                             src="{{URL::to('public/fontend/img/products/' . ($order->orderDetails[0]->product->productImages[0]->path ?? ''))}}" alt="">
                                                    </div>
                                                </div>
