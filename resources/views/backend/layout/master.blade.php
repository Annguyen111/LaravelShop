...
<head>
    ...
    <link href="{{asset('public/backend/my_style.css')}}" rel="stylesheet">
</head>
<style>
    i.rating{
        color: #e5e50d;
...
<body>
                                        ...
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                           class="p-0 btn">
                                            <img width="42" class="rounded-circle"
                                                 src="{{URL::to('public/fontend/img/user/' . \Illuminate\Support\Facades\Auth::user()->avatar ?? 'default-avatar.jpg')}}"
                                                 alt="">
                                                            ...
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img style="width: 40px; height: 40px" class="rounded-circle"
                                                                         src="{{URL::to('public/fontend/img/user/' . \Illuminate\Support\Facades\Auth::user()->avatar ?? 'default-avatar.jpg')}}" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <a href="{{ route('admin.logout') }}" class="btn-pill btn-shadow btn-shine btn btn-focus">
                                                                        Logout
                                                                    </a>
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="mm-active">
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('dashboard')}}" class="{{ (request()->segment(2) == 'dashboard') ? 'mm-active' : ''  }}">
                                            <i class="metismenu-icon" ></i>Dashboard
                                        </a>
                                    </li>
                                    @if (Auth::check() && Auth::user()->level == 0)
                                        <li>
                                            <a href="{{URL::to('admin/user')}}" class="{{ (request()->segment(2) == 'user') ? 'mm-active' : ''  }}">
                                    ...
                                    <li>
                                        <a href="{{ route('blog.index') }}" class="{{ (request()->segment(2) == 'blog') ? 'mm-active' : ''  }}">
                                            <i class="metismenu-icon" ></i>Blog
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.contact') }}" class="{{ (request()->segment(2) == 'contact') ? 'mm-active' : ''  }}">
                                            <i class="metismenu-icon" ></i>Contact
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('comment.index') }}" class="{{ (request()->segment(2) == 'comment') ? 'mm-active' : ''  }}">
                                            <i class="metismenu-icon" ></i>Comment
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('slider.index') }}" class="{{ (request()->segment(2) == 'slider') ? 'mm-active' : ''  }}">
    ...
    <script src="{{asset('public/backend/assets/scripts/jquery-3.2.1.min.js')}}"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>

    <script type="text/javascript" src="{{asset('public/backend/assets/scripts/main.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/backend/assets/scripts/my_script.js')}}"></script>
